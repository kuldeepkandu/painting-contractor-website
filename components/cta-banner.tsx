    ...
    <section className="brand-gradient text-accent-foreground">
      <div className="mx-auto flex max-w-7xl flex-col items-center gap-6 px-4 py-14 text-center md:px-6 md:py-16">
        ...
        <div className="flex flex-col gap-3 sm:flex-row">
          ...
          <a href={siteConfig.phoneHref} className="inline-flex items-center justify-center rounded-full border border-accent-foreground/30 bg-transparent px-5 py-2.5 font-medium text-accent-foreground transition-all hover:bg-accent-foreground/10">
